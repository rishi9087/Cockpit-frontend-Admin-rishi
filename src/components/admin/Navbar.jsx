...
const suggestionsList = [
  ...
  // Only include these if instituteId is NOT present
  ...(!instituteId ? [
    { label: 'Pricing', path: `${routePrefix}/pricing` },
    { label: 'Institution', path: `${routePrefix}/institution` },
    { label: 'Advertisement', path: `${routePrefix}/advertise` },
  ] : []),

  // Only include 'Test' if adminId is NOT present
  ...(!adminId ? [
